...
echo -e "${green}\n\nTesting [ cd ../0x16_Tests ]  in the shell ==============================================\n"
echo -e "${red}>>>>> OUR Shell Result:\n${reset}"
echo "cd ../0x16_Tests ; echo "Returned : \$?" ; echo 'pwd : ' ; pwd" | ../simple_shell #the command to test in our shell
echo -e "\n${red}>>>>> Expected : \n${reset}"
echo "cd ../0x16_Tests ; echo "Returned : \$?" ; echo 'pwd : ' ; pwd" | /bin/sh #test same command in sh shell for comparing results
